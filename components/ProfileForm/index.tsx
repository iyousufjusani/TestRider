...
import updateProfileValidation from "../../validations/updateProfile";
  ...
  const handleSubmit = async (
    ...
    if (values.email !== user?.email) {
      ...
      if (data?.code !== "auth/user-not-found") {
        formikHelper.setErrors({ email: "Email is already exist" });
        return;
      }
    }
        ...
        {({
          ...
          <Form onSubmit={handleSubmit} className="d-flex flex-column gap-3">
            <div className="d-flex gap-2">
              ...
              <Form.Group controlId="lastName" className="w-50">
                <FormControl
